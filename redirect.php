...
<head>
    <title> Care Fund - Thankyou page!</title>
  ...
  <!--NAVBAR START -->
    <nav class="navbar navbar-dark bg-secondary navbar-expand-sm fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand mr-auto" href="index.html"><i> Care Fund</i></a>
...
<!--THANKYOU CARD-->
    <div class="container" style="padding-top: 20px;">
      <div class="page-header" style="background-color: white;opacity:0.8;">
        <strong><p style="font-size:34px;"><i> Care Fund - Thankyou For Your Donation!</i></p></strong>
